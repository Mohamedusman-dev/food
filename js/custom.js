...
(function($) {
    "use strict";
		...
		jQuery(".orange-bg").on('click',function(){
			jQuery(".logo-header img").attr("src", "https://files.catbox.moe/ae1iri.png");
			jQuery(".footer-logo .text-center img").attr("src", "https://files.catbox.moe/ae1iri.png");
			return false;
		});

		jQuery(".strong-blue-bg").on('click',function(){
			jQuery(".logo-header img").attr("src", "https://files.catbox.moe/cye5f3.png");
			jQuery(".footer-logo .text-center img").attr("src", "https://files.catbox.moe/cye5f3.png");
			return false;
		});

		jQuery(".moderate-green-bg").on('click',function(){
			jQuery(".logo-header img").attr("src", "https://files.catbox.moe/kxqqfc.png");
			jQuery(".footer-logo .text-center img").attr("src", "https://files.catbox.moe/kxqqfc.png");
			return false;
		});

		jQuery(".vivid-yellow-bg").on('click',function(){
			jQuery(".logo-header img").attr("src", "https://files.catbox.moe/g89qcb.png");
			jQuery(".footer-logo .text-center img").attr("src", "https://files.catbox.moe/g89qcb.png");
			return false;
		});
